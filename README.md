...
This section shows the full multimodal processing pipeline for a single user request in all of the three churches: San Falcione, Santa Maria de Idris, and Santa Barbara.
